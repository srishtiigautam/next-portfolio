...
const desktopData = [
  { language: "adobexd", desktop: 85, fill: "var(--color-pink)" },
  { language: "figma", desktop: 80, fill: "var(--color-blue)" },
  { language: "qtdesigner", desktop: 90, fill: "var(--color-purple)" },
];
...
export default function DesignSkills() {
  ...
  const languages = React.useMemo(
    () => desktopData.map((item) => item.language),
    []
  );
